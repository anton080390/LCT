...
const services = [
  {
    ...
    image: s1,
    fullDescription:
      "Ми спеціалізуємося на перевалці та зберіганні зернових, зернобобових і олійних культур, забезпечуючи повний цикл логістичних операцій. У Миколаєві розташовані сучасні склади відкритого та закритого типу, обладнані для приймання та зберігання різних видів аграрної продукції. Також доступні спеціалізовані ємності для олійних культур, що гарантує збереження їхньої якості. В Ізмаїлі функціонують склади закритого зберігання, оптимізовані для зернових вантажів, з дотриманням міжнародних стандартів безпеки та контролю вологості. Ми пропонуємо як коротко-, так і довгострокове зберігання з можливістю швидкої перевалки на судна, вагони чи автомобільний транспорт. Такий підхід забезпечує безперервність логістики, мінімізує втрати та гарантує якість вашої продукції на всіх етапах.",
  },
  {
  ...
  },
  {
    ...
    image: s5,
    fullDescription:
      "Ми надаємо послуги зі зберігання та перевалки вантажів відкритого зберігання, серед яких вугілля, глина, металеві вироби, а також продукція у біг-бегах. Наші майданчики у Миколаєві оснащені твердим покриттям, що забезпечує надійність та зручність у роботі з великотоннажними і сипучими вантажами. Всі операції виконуються із дотриманням екологічних норм та стандартів безпеки. Завдяки зручному розташуванню терміналів ми організовуємо ефективну перевалку на судна, залізничний або автомобільний транспорт. Такий підхід дозволяє оптимізувати логістичні витрати, зберегти якість продукції та гарантувати безперервність постачання.",
  },
  {
